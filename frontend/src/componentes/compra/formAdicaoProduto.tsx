...
export default class FormAdicaoProduto extends Component<props> {
        ...
        return (
            <div className="container-fluid">
                <form>
                    ...
                    <div className="input-group mb-3">
                        <button className="btn btn-outline-secondary" type="button" style={{ background: tema }}>Comprar Produto</button>
                    </div>
                </form>
            </div>
        )
